/*
  ...
  2. Indexes
    - Unique index on physical_sales to ensure only one pending sale per artwork
  ...
  4. Functions
    - propose_physical_sale: Creates a new sale proposal
    - vote_on_physical_sale: Records a shareholder's vote
